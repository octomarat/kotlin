...
public class CompileTimeConstantUtils {
    ...
    public static boolean canBeReducedToBooleanConstant(
        ...
        if (!(compileTimeConstant instanceof ConstantValueCompileTimeConstant) || compileTimeConstant.usesVariableAsConstant()) return false;

        ConstantValue constantValue = ((ConstantValueCompileTimeConstant) compileTimeConstant).getConstantValue();
