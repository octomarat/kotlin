...
public class CompileTimeConstantChecker {
    ...
    public boolean checkConstantExpressionType(
            @Nullable ConstantValueCompileTimeConstant compileTimeConstant,
    ...
    private boolean checkIntegerValue(
            @Nullable ConstantValueCompileTimeConstant value,
            @NotNull JetType expectedType,
            @NotNull JetConstantExpression expression
    ) {
        if (value == null) {
    ...
    private boolean checkCharValue(ConstantValueCompileTimeConstant<?> constant, JetType expectedType, JetConstantExpression expression) {
        if (!noExpectedTypeOrError(expectedType)
