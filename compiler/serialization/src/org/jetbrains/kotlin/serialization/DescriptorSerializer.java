...
public class DescriptorSerializer {
    ...
    public ProtoBuf.Callable.Builder callableProto(@NotNull CallableMemberDescriptor descriptor) {
        ...
        if (descriptor instanceof PropertyDescriptor) {
            ...
            ConstantValueCompileTimeConstant<?> compileTimeConstant = propertyDescriptor.getCompileTimeInitializer();
            hasConstant = !(compileTimeConstant == null || compileTimeConstant.getConstantValue() instanceof NullValue);
        }
