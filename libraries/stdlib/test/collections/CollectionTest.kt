...
class CollectionTest {
    ...
    test fun minusElement() {
        ...
        val b: List<String> = a - "bar" - "zoo"
        assertEquals(listOf("foo", "bar"), b)
    }

    test fun minusCollection() {
        val a = listOf("foo", "bar", "bar")
        val b: List<String> = a - listOf("bar", "zoo")
        assertEquals(listOf("foo"), b)
    }

    test fun minusArray() {
        val a = listOf("foo", "bar", "bar")
        val b: List<String> = a - arrayOf("bar", "zoo")
        assertEquals(listOf("foo"), b)
    }
