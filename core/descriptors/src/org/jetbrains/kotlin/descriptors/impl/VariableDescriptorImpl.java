...
public abstract class VariableDescriptorImpl extends DeclarationDescriptorNonRootImpl implements VariableDescriptor {
    ...
    protected NullableLazyValue<ConstantValueCompileTimeConstant<?>> compileTimeInitializer;
    ...
    @Nullable
    @Override
    public ConstantValueCompileTimeConstant<?> getCompileTimeInitializer() {
    ...
    public void setCompileTimeInitializer(@NotNull NullableLazyValue<ConstantValueCompileTimeConstant<?>> compileTimeInitializer) {
